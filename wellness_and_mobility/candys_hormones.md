# CANDY'S HORMONE & BHRT TRACKER

## 1. BHRT REGIMEN BASELINE
* **BiEst (Estrogen):** 1 pump (15 mL pump cream) every morning. *(Never apply to breast tissue—inner arms/thighs/lower abdomen only).*
* **Testosterone:** 1 pump Monday to Friday (2 days off: Saturday & Sunday).
* **Progesterone:** 1 pump every evening (1 day off: Sunday).
* **Medication Context:** Ozempic (18 clicks) + Vyvanse (40mg).
* **Surgical Status:** Hysterectomy (uterus removed), **ovaries intact**.

---

## 2. SEPTEMBER – OCTOBER 2026 CYCLE ROADMAP (DAY 1 = SEPT 8)

| Cycle Days | Calendar Dates | Phase | Oura Temp Expected | Hormone State | Workouts & Nutrition | Key Focus & Symptoms |
|------------|----------------|-------|-------------------|---------------|----------------------|----------------------|
| **Days 1–4** | **Sept 8 – Sept 11** | **Push Reset** | Baseline (0.0°C) | Progesterone drops; Estrogen starting to rise | Gentle movement, Yoga, hydration | **Histamine Window:** Itchy scalp/breasts/skin on Days 1–3 as estrogen shifts |
| **Days 5–13** | **Sept 12 – Sept 20** | 🟢 **Peak Push Phase** | Baseline / Low (-0.1°C to 0.0°C) | Estrogen climbing to peak | **Push Mode:** 3x Strength/wk, progressive overload, 135g+ protein | High energy, sharp focus, fast recovery, natural de-puffing |
| **Days 14–16** | **Sept 21 – Sept 23** | 🔄 **Ovulation Shift** | Transitioning UP (+0.1°C → +0.3°C) | Estrogen peak → Progesterone starts rising | Maintain strength or light mobility | Watch Oura temp for 2 consecutive nights of elevation (+0.2°C+) |
| **Days 17–25** | **Sept 24 – Oct 2** | 🟡 **Protect Phase** | Elevated (+0.2°C to +0.4°C) | Progesterone dominant | **Protect Mode:** Lighter weights, mobility flows, higher healthy fats | Satiety focus, 7 PM kitchen close, fluid retention defense |
| 🩸 **Days 19–21** | **Sept 26 – Sept 28** | 🩸 **TEST WINDOW** | Elevated (+0.2°C+) | **Peak Progesterone** | Normal Protect routine | **FINGER PRICK TEST WINDOW:** Take test in AM before morning BiEst |
| **Days 26–27** | **Oct 3 – Oct 4** | **Luteal End** | Dropping back to baseline | Progesterone falling | Gentle walks, hydration | Next cycle reset preparing |

---

## 3. MULTI-MONTH OURA CYCLE PATTERN ANALYSIS (JULY – SEPTEMBER 2026)

> **Key Discovery:** Despite having no menstrual bleed due to your hysterectomy, your Oura temperature data reveals a **textbook, highly regular ~25-day ovarian cycle** with distinct elevated (Luteal/Protect) and baseline (Follicular/Push) phases!

### Cycle Summary
* **Cycle 1 (July 10 – Aug 4):** 
  * *High Temp Phase:* July 10 – July 24 (+0.12°C to +0.44°C) — 15 days
  * *Low Temp Reset:* July 25 – Aug 4 (-0.02°C to -0.30°C) — 11 days
* **Cycle 2 (Aug 5 – Aug 27):**
  * *High Temp Phase:* Aug 5 – Aug 16 (+0.07°C to +0.54°C) — 12 days
